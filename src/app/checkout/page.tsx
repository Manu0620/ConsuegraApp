...
export default function CheckOut() {
   ...
   const submitCustomer = customerForm.handleSubmit(
         ...
         <section className="flex flex-col mt-36 relative items-center justify-center w-full min-h-screen bg-white overflow-hidden">
            {loading ? (
               ...
               <div className="flex flex-col w-1/2 my-12 px-8 py-12 lg:w-1/2 md:w-full md:px-16 sm:w-full mobile:w-full mobilesm:w-full">
                  <h1 className="text-red-800 flex-col font-bold pb-8 text-start self-start mobilesm:text-2xl mobile:text-2xl md:text-3xl lg:text-3xl">
                     Información personal
                     <span className="flex text-sm font-light text-gray-700">
                        Rellene los datos necesarios para continuar con su
                        pedido.
                     </span>
                  </h1>
                  <CustomerInfoForm
               ...
               <div className="flex flex-col h-full my-12 px-8 py-12 lg:w-1/2 md:w-full md:px-16 sm:w-full mobile:w-full mobilesm:w-full">
                  <h1 className="text-red-800 flex-col font-bold pb-8 text-start self-start mobilesm:text-2xl mobile:text-2xl md:text-3xl lg:text-3xl">
                     ...
                     <span className="flex text-sm font-light text-gray-700">
                        Complete los campos siguientes para agregar su
                        dirección.
                     </span>
                  </h1>
                  <AddressForm
