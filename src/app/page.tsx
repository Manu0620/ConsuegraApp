...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-0 m-0">
      <Menu />
      <section className="slider-container mt-36 relative z-30 flex flex-row w-full items-center shadow-md bg-white border border-transparent rounded-bl-[60px] rounded-br-[30px]"> 
        <Swiper
      ...
      <section className="mt-[-60px] pb-10 relative z-20 flex flex-col w-full min-h-[70vh] shadow-md items-center justify-start bg-gray-100 border border-transparent rounded-bl-[60px] rounded-br-[30px]"> 
        <h1 className="pt-20 text-3xl text-blue-900 font-bold m-10 text-pretty text-center mobilesm:text-xl mobile:text-xl md:text-2xl lg:text-3xl">Nuestro compromiso es <span className="text-red-800">contigo</span>.</h1>
        {
      ...
      <section className="mt-[-60px] relative z-10 flex flex-col w-full min-h-[70vh] shadow-md items-center justify-center bg-red-100 border border-transparent rounded-bl-[60px] rounded-br-[30px]"> 
        <h1 className="pt-20 text-3xl text-red-800 font-bold m-10 text-pretty text-center mobilesm:text-xl mobile:text-xl md:text-2xl lg:text-3xl">Tenemos gran variedad de productos <span className="text-blue-900">para ti</span>.</h1>
        <Category />
      </section>
        ...
        <div className="product-carousel flex flex-row flex-wrap mx-50 my-10 w-3/4 justify-center items-center">
          {productos.map((producto, index) => (
              <div key={index} className="card mx-10 my-3 flex flex-col basis-2/12 w-full h-full items-center justify-center text-pretty">
                ...
                <h1 className="mt-5 text-md text-blue-900 font-semibold self-center">{producto.name}</h1>
