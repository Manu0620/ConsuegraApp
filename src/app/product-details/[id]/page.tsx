...
export default function ProductDetails() {
    ...
    return(
        ...
        <main className="flex flex-col items-center p-0 bg-red">
            <section 
                className="hero-products flex flex-col w-full py-12 px-6 bg-white border-b border-red-700 mt-48 shadow-md text-start items-center overflow-hidden"> 
                <div className="flex flex-row flex-wrap gap-12 w-10/12 text-start justify-center">
                    ...
                    <ScrollArea className="min-h-20 flex flex-col space-y-3"> 
                        <h1 className="flex flex-col text-red-800 font-bold leading-snug mobilesm:text-xl mobile:text-xl sm:text-2xl md:text-3xl lg:text-3xl">
                            ...
                            <span className="text-[16px] font-normal text-black">Categoría</span>
                        </h1>
                        ...
                        {product?.images ? 
                            <div className="flex flex-row border-t-2 border-red-700 py-3 ">
                                {product.images.map((image, index) => (
                                    <img key={index} src={image} className="w-28 h-28 p-2 space-x-2 aspect-square contrast-125 rounded-xl basis-1/4 object-contain hover:border-red-800 hover:border-2" />                           
                                ))}
                            </div> 
                        : null}
                        ...
                        <div className="flex flex-row items-center py-2">
                            <div className="flex flex-row pr-2">
                                ...
                                <Input  onChange={handleInputChange} onBlur={handleBlur}  value={quantity} className="border-none font-medium w-20 text-red-800 text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                            ...
                            <div className="flex grow ">
                                <Button onClick={handleClick} className="text-red-800 w-full space-x-3 gap-2 text-md border border-red-800 self-center font-medium rounded-xl hover:bg-red-700 hover:text-white outline-none">
