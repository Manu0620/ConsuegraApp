...
export default function Empleo() {
   return (
      <main className="flex min-h-screen flex-col items-center p-0 bg-red">
         <section className="hero-nosotros flex flex-row bg-red-50 mt-48 shadow-md text-center items-center w-full min-h-60 overflow-hidden">
            <h1 className="flex flex-col ml-28 text-red-800 font-bold text-pretty leading-none mobilesm:text-2xl mobile:text-2xl sm:text-3xl md:text-4xl lg:text-4xl">
               Empleate con nosotros
            </h1>
         </section>
            ...
            <div className="flex flex-row flex-wrap w-full space-y-5 lg:items-start lg:justify-start md:items-start md:justify-center sm:items-start sm:justify-center mobile:items-start mobile:justify-center mobilesm:items-start mobilesm:justify-center ">
               <div className="flex flex-col text-pretty space-y-5 lg:w-1/2 lg:p-16 md:w-full md:px-32 sm:w-full mobile:w-full mobilesm:w-full">
                  ...
                  <p className="text-gray-800 font-light lg:text-[16px] md:text-md sm:text-sm mobile:text-sm mobilesm:text-sm">
                     Una invitación para formar parte de una organización
                     dinámica y en crecimiento, comprometida con la excelencia,
                     la innovación y el impacto positivo. Al unirte a nuestro
                     equipo, tendrás la oportunidad de contribuir a proyectos
                     significativos, trabajar en un entorno colaborativo y
                     desarrollar tus habilidades profesionales en un ambiente
                     que fomenta el aprendizaje y el crecimiento. Buscamos
                     personas apasionadas, comprometidas y con ganas de hacer la
                     diferencia, tanto en la empresa como en la comunidad.
                  </p>
