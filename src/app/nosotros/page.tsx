        ...
        <div className="flex flex-row flex-wrap-reverse pb-6 space-y-12 min-h-[30vh] lg:w-10/12 lg:flex-row md:w-10/12 md:flex-col-reverse sm:w-full  sm:flex-col-reverse mobile:w-full mobile:flex-col-reverse mobilesm:w-full mobilesm:flex-col-reverse">
          <div className="flex flex-col basis-7/12 justify-center items-center text-pretty text-center text-red-700 ">
            ...
            <p className="text-start text-gray-800 font-normal lg:text-md lg:px-12 md:text-md md:px-0 sm:text-[14px] sm:px-0 mobile:text-[14px] mobile:px-0 mobilesm:text-[14px] mobilesm:px-0">
              En el año 2006, siendo el Sr. Ramón Consuegra un vendedor el cual
              decide dejar la empresa para la cual laboraba, para emprender una
              visión de ser independiente, comienza a trazar su propio camino
              como vendedor independiente y tras el éxito del mismo, este decide
              constituir su propia empresa la cual llamó “RM Consuegra, S.R.L.”
              <br /> <br />
              En el año 2007, el Sr. Ramón Consuegra se motiva y toma la
              importante decisión de alquilar un local en el municipio La Ortega
              Moca para emprender su negocio. Por consiguiente, este decide
              inaugurar la apertura de su negocio, el cual abrió sus puertas e
              inició sus labores con un personal de tan solo 5 empleados.
              <br />
              <br />
              Desde muy joven soñaba con ser empresario, poseía unas ganas
              inmensas de emprender, acompañadas de un sin número de ideas de
              negocio las cuales estaban relacionadas en el área eléctrica. La
              noción de obtener su propio negocio surge en un momento dado
              mientras hablaba con su esposa, a la cual le comentó la idea de
              que este deseaba formar una empresa para vender materiales
              eléctricos.
              <br /> <br />
              El apoyo sobre esta propuesta fue recibido de parte de su esposa y
              la misma procura ayudarle a luchar por su sueño. Luego con el
              pasar del tiempo fueron adquiriendo más experiencia de negocio y
              su empresa fue progresando constantemente.
              <br /> <br />
              Hoy en día la empresa “RM Consuegra, S.R.L.” cuenta con un
              personal mayor de 300 empleados y con cinco tiendas de ventas al
              detalle en la región Norte, las cuales, con la calidad de sus
              productos y un servicio especializado, los clientes la
              caracterizan como su principal suplidor eléctrico.
            </p>
          </div>
            ...
            <Principle
              ...
              icon={
                principle.titulo == 'Misión' ? (
                  <FaBullseye size={120} className="flex text-red-800" />
                ) : principle.titulo == 'Visión' ? (
                  <BsEyeFill size={120} className="flex text-red-800" />
                ) : (
