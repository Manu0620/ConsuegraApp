...
export default function Agrovet() {
   return (
      <main className="flex min-h-screen flex-col items-center p-0 bg-red">
         <section className="hero-agrovet bg-cover bg-top bg-[url('/agrovet-hero.png')] mt-36 relative z-30 flex flex-row w-full h-[50vh] items-center bg-blue-950 border border-transparent rounded-bl-[60px] rounded-br-[30px]"></section>
         <section className="mt-[-60px] relative z-20 flex flex-col w-full min-h-[60vh] items-center bg-gray-100 border border-transparent rounded-bl-[60px] rounded-br-[30px]">
            <div className="mt-28 mb-10 flex flex-row w-3/4 bg-white shadow-xl border border-transparent rounded-[25px] text-pretty">
               <div className="flex flex-col relative basis-1/2 p-10 justify-center items-center">
                  <h1 className="text-3xl text-red-700 font-bold m-3">
                     Contacto
                  </h1>
                  <div className="flex flex-row m-3 w-full">
                     ...
                     <div className="flex flex-col basis-1/3 justify-center items-center mx-4 text-center">
                        ...
                        <h1 className="font-normal text-red-700">
                           Correo Electrónico
                        </h1>
                        <h1 className="font-bold text-sm text-red-700">
                           adm@rmconsuegra.com
                  ...
                  <div className="social-media flex flex-row absolute bottom-5 inset-x-0 basis-1/2 mt-2 justify-center items-center text-white text-lg font-medium">
                     <Link
                        ...
                        className="mx-2 p-3 h-fit flex items-center text-pretty border-2 border-red-700 rounded-full hover:bg-red-700/25"
                        target="_blank"
                     >
                        <svg
                           className="w-6 h-6 text-red-700 dark:text-red-700"
                           aria-hidden="true"
                           xmlns="http://www.w3.org/2000/svg"
                           width="24"
                           height="24"
            ...
            <h1 className="text-3xl text-red-700 font-bold my-5 text-pretty">
               Ubicación.
            </h1>
            <iframe
               className="w-full border border-transparent rounded-bl-[60px] rounded-br-[30px]"
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3763.4468537142066!2d-70.53416632400797!3d19.393089541939947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8eb1d1603c44c227%3A0x6e613e2b3433bc97!2sAgrovet%20Consuegra!5e0!3m2!1ses!2sdo!4v1723667782862!5m2!1ses!2sdo"
               width="800"
               height="600"
               loading="lazy"
            ></iframe>
