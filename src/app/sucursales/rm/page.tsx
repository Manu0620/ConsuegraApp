  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-0 bg-red">
      ...
      <section className="mt-[-60px] relative z-20 flex flex-col w-full min-h-[60vh] items-center bg-blue-100 border border-transparent rounded-bl-[60px] rounded-br-[30px]"> 
        ...
        <div className="mt-28 mb-10 flex flex-row w-full min-h-96">
            <div className="flex basis-1/2 px-20 justify-center items-center">
              <h1 className="text-3xl text-blue-900 font-bold">Información.</h1>
              
            </div>
            <div className="flex basis-1/2 justify-start items-center">
              <Image className="shadow-lg min-w-fit min-h-fit m-30 object-contain border-2 border-blue-900 rounded-[30px] overflow-hidden" src={'/rm-fachada.jpg'} alt="..." width={500} height={500} />
            </div>
        </div>

        <h1 className="text-3xl text-blue-900 font-bold my-5 text-pretty">Ubicación.</h1>
