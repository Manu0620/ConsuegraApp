        ...
        <div className="flex grow items-center justify-center px-3">
            <form className="w-1/2">   
                <div className="relative">
                    ...
                    <input type="search" id="search" className="block outline-none w-full p-4 ps-10 text-sm text-blue-900 border border-red-700 rounded-[15px] bg-gray-50 focus:ring-red-500 focus:border-[2px] white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400 white:text-white white:focus:ring-red-500 white:focus:border-red-500" placeholder="Busca un articulo por nombre o por # de articulo..." required />
