            ...
            <form className="flex flex-row flex-wrap gap-3 items-end justify-center w-full">
                <FormField
                    ...
                    <FormItem className="w-2/4">
                        ...
                        <FormControl onChange={filterProducts} className="border-red-800 focus:bg-red-700/25 text-red-800 font-medium rounded-xl">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                    <FormItem>
                        <FormLabel className="text-red-800 font-semibold">Por clase</FormLabel>
                        <Select onValueChange={(value) => classChange(value)} value={selectedClass} defaultValue={selectedClass} >
                ...
                <FormField
                    ...
                    render={({ field }) => (
                    <FormItem>
                        <FormLabel className="text-red-800 font-semibold">Por precio (RD$)</FormLabel>
                        <FormControl onChange={filterProducts} className="relative border-red-800 focus:bg-red-700/25 text-red-800 font-medium rounded-xl">
