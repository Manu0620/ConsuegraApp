        ...
        <footer className="mt-[-60px] flex flex-row flex-wrap pt-16 w-full min-h-[55vh] justify-center items-center bg-red-800 text-white text-pretty">
            <div className='flex flex-row flex-wrap w-full justify-center items-start lg:basis-4/6 lg:pl-10 lg:flex-row lg:items-start md:basis-5/6 md:flex-col md:items-center sm:basis-full sm:flex-col sm:items-center mobile:basis-full mobile:flex-col mobile:items-center mobilesm:basis-full mobilesm:flex-col mobilesm:items-center'>
                ...
                <div className="flex flex-col basis-3/12 text-pretty items-center justify-center lg:mb-0 md:mb-10 sm:mb-10 mobile:mb-10 mobilesm:mb-10"> 
                    <h1 className='text-white font-medium text-lg mb-3'>Podria interesarte</h1>
                    <ul className='flex flex-col flex-wrap font-light leading-6 lg:flex-col lg:justify-start md:flex-row md:justify-center sm:flex-row sm:justify-center mobile:flex-col mobilesm:flex-col'>
                        <Link className='py-1 px-3 ' href={'/documents/catalogo-productos-consuegra.pdf'} target='_blank'>
                            Catalogo de productos
                        </Link>
                        <Link className='py-1 px-3'  href={'/nosotros'}>
                            Sobre Nosotros
                        </Link>
                        <Link className='py-1 px-3'  href={'/contacto'}>
                           Nuestros suplidores
                        </Link>
                        <Link className='py-1 px-3'  href={'/contacto'}>
                           Contacto
            ...
            <div className='flex flex-col relative basis-4/12 p-10 w-full text-pretty items-center mobilesm:basis-full mobile:basis-full sm:basis-full md:basis-8/12 lg:basis-4/12'>
                ...
                <form action="" className='flex flex-col m-5 w-full justify-center items-center'> 
                    <div className='flex flex-row w-3/4 justify-center items-center'>
                        <input 
                            className="block outline-none m-1 ml-0 p-4 w-1/2 text-sm text-white border-2 border-white rounded-[15px] bg-transparent focus:bg-white/25" 
                            placeholder="Nombre... " 
                            required />

                        <input 
                            type='email' 
                            className="block outline-none m-1 mr-0 p-4 w-1/2 text-sm text-white border-2 border-white rounded-[15px] bg-transparent focus:bg-white/25" 
                            placeholder="Correo Electronico... " 
                            required />
                    </div>  
                    <textarea
                        className="block outline-none m-1 p-4 w-3/4 h-24 text-sm text-white border-2 border-white rounded-[15px] bg-transparent focus:bg-white/25 " 
