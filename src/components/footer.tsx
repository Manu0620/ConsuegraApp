...
export const Footer = () => {
    return(
        <footer className="mt-[-60px] flex flex-row flex-wrap pt-16 w-full min-h-[55vh] justify-center items-center bg-red-800 text-white text-pretty">
            <div className='flex basis-4/6 w-full'>

            </div>
            <div className='flex flex-col relative basis-4/12 m-10 w-full text-pretty  items-center mobilesm:basis-full mobile:basis-full sm:basis-full md:basis-7/12 lg:basis-4/12'>
                ...
                <form action="" className='flex flex-col px-14 m-5 w-full justify-center items-center'> 
                    <div className='flex flex-row w-full justify-center items-center'>
                        ...
                        <input className="block outline-none m-1 mr-0 p-4 w-1/2 text-sm text-white border-2 border-white rounded-[15px] bg-transparent focus:bg-white/25" placeholder="Correo Electronico... " required />
                    </div>  
                    <textarea className="block outline-none m-1 p-4 w-full h-24 text-sm text-white border-2 border-white rounded-[15px] bg-transparent focus:bg-white/25 " placeholder="Su mensaje... "  required />
                    <div className='flex flex-row flex-wrap-reverse w-full justify-center'>
