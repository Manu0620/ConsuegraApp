...
export const InfoCard = (props: Props) => {
    return(
        <>
            ...
            :
                <div key={props.title}  className="bg-white flex flex-row flex-wrap mb-8 ml-28 w-6/12 min-h-70 border border-transparent rounded-[25px] shadow-md lg:w-6/12 lg:ml-28 lg:flex-row md:w-9/12 md:ml-0 md:flex-col-reverse sm:w-9/12 sm:ml-0 sm:flex-col mobile:w-9/12 mobile:ml-0 mobile:flex-col-reverse overflow-hidden">
