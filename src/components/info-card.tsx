         ...
         {props.isReverse ? (
            ...
            >
               <div className="flex flex-col basis-7/12 p-10 bg-red-50 justify-center items-center text-pretty text-center text-red-900">
                  ...
                  <p className="text-sm text-center text-gray-700 pt-2 font-normal lg:text-md md:text-md sm:text-[14px] mobile:text-[12px] mobilesm:text-[12px]">
                     {props.body}
                  </p>
               </div>
               <div className="flex basis-5/12 ">
                  <img
                     className="contrast-125 object-cover"
                     src={props.image}
                     alt="..."
                  />
               </div>
            ...
            >
               <div className="flex flex-col basis-7/12 p-10 bg-blue-50 justify-center items-center text-pretty text-center text-blue-900 ">
                  <h1 className="text-xl font-bold">{props.title}</h1>
                  <p className="text-sm text-gray-700 pt-2 font-normal lg:text-sm md:text-md sm:text-[14px] mobile:text-[12px] mobilesm:text-[12px]">
                     {props.body}
                  </p>
               </div>
               <div className="flex basis-5/12">
