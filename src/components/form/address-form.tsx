...
export const AddressForm = (props: CustomerInfoFormProps) => {
   ...
   return(
       <>
           <Form {...form}>
               <form onSubmit={onSubmit} className="customer-info flex flex-col gap-3 text-start w-full h-full">
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem className="basis-1/2">
                           <FormLabel className="text-red-800 font-semibold">Nombre completo</FormLabel>
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                           ...
                           <FormItem className="basis-1/2">
                              <FormLabel className="text-red-800 font-semibold">Linea de dirección 1 *</FormLabel>
                              <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                           <FormItem className="basis-1/2">
                              <FormLabel className="text-red-800 font-semibold">Linea de dirección 2</FormLabel>
                              <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                           <FormItem className="basis-1/2">
                              <FormLabel className="text-red-800 font-semibold">Ciudad</FormLabel>
                              <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
                                 <Input placeholder="Introduzca su ciudad..." {...field} />
                              </FormControl>
                  ...
                  />
                   <div className="flex flex-row w-full gap-5">
                     <FormField
                        ...
                        render={({ field }) => (
                        <FormItem className="basis-1/2">
                              <FormLabel className="text-red-800 font-semibold">Provincia</FormLabel>
                              <Select onValueChange={(value) => field.onChange(value)} // Conecta el onChange del campo
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem className="basis-1/2">
                              <FormLabel className="text-red-800 font-semibold">Código postal</FormLabel>
                              <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
                   ...
                   <FormField
                     ...
                     render={({ field }) => (
                        <FormItem>
                           <FormLabel className="text-red-800 font-semibold">Instrucciones de entrega</FormLabel>
                           <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
                              <Textarea
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem className="basis-1/2">
                           <FormLabel className="text-red-800 font-semibold">Pais</FormLabel>
                           <FormControl className="border-red-800 focus:bg-red-800/25 text-red-800 font-medium rounded-xl">
