        ...
        <AlertDialog open={isOpen}>
            <AlertDialogContent className="bg-white/90 border-2 border-red-800 rounded-3xl text-red-800">
                ...
                <AlertDialogFooter className="text-semibold">
                    <AlertDialogCancel onClick={onCancel} className="rounded-xl hover:bg-red-800/75 hover:text-white">No</AlertDialogCancel>
                    <AlertDialogAction onClick={onAccept} className="flex flex-row items-center gap-2 rounded-xl border border-red-800 hover:bg-red-800 hover:text-white"><PiCheckCircleBold /> Si</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    );
