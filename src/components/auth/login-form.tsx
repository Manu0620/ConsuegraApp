...
export const LoginForm = (props: { open? : boolean, setOpen?: (open: boolean) => void, close?: () => void }) => {
         ...
         <Dialog open={isLogOpen}>
            ...
            <DialogContent className="bg-red-50 text-red-800 border-red-800 rounded-3xl lg:w-3/12 md:w-6/12 sm:w-8/12 mobile:w-10/12 mobilesm:w-11/12">
               <DialogTitle className="flex flex-col items-center justify-center text-start">
                  ...
                  <h1 className="text-red-800 font-bold text-lg leading-none">Inicio de sesión</h1>
               </DialogTitle>
               ...
               <Form {...form}>
                  <form onSubmit={onSubmit} className="flex flex-col gap-3 w-full">
                     <FormField
                        ...
                        <FormItem>
                              ...
                              <FormControl className="border-red-800 w-full focus:bg-red-800/25 text-gray-800 font-medium rounded-xl">
                                 <Input placeholder="john.doe123@gmail.com..." {...field} />
                              </FormControl>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                        <FormItem>
                              <FormLabel className="text-red-800 font-semibold">Contraseña</FormLabel>
                     ...
                     <Link href="/auth/forgot-password">
                        <p className="flex text-red-800 font-medium text-[12px] hover:underline">¿Olvidaste tu contraseña?</p>
                     </Link>
                     ...
                     <Button 
                        ...
                        className="border border-red-800 text-red-800 font-semibold rounded-xl hover:bg-red-800/75 hover:text-white hover:scale-105 transition ease-linear duration-100">
                           {loading ? <LuLoader2 className="mr-2 animate-spin" /> : <IoEnterSharp className="mr-2"/>}  Iniciar sesión
                     </Button>
                  </form>
               </Form>
               <Button
